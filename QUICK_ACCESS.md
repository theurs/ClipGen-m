...
Для лучшей совместимости с различными форматами аудио рекомендуется использовать установленный в системе ffmpeg для предварительной конвертации файлов в поддерживаемые форматы (MP3, WAV), особенно при работе с geminillm, которая может иметь ограничения по поддержке аудио форматов API.